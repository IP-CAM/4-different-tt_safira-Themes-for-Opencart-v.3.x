...
class ControllerAccountOrder extends Controller {
	public function index() {
		...
		foreach ($results as $result) {
			...
			$data['orders'][] = array(
                ...
                'reorder'    => $this->url->link('vltech/reorder/current', 'order_id=' . $result['order_id'], true), // VL.Tech
	...
	public function info() {
		...
		if ($order_info) {
			...
			// VL.Tech
            $data['re_order_all'] = $this->url->link('vltech/reorder/current', 'order_id=' . $this->request->get['order_id'], true);
